...
public sealed class StringToLower : IFunctionDescriptorResolver
{
    ...
    {
        if (StringComparer.InvariantCultureIgnoreCase.Equals(name, Names.Lower)
        ...
        {
            descriptor = StringToLowerDescriptor.Singleton;
            return true;
        }
        descriptor = default;
        return false;
